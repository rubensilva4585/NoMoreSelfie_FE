                                                        ...
                                                        <div className="space-y-6 bg-white border-t-2 border-orange-400 rounded-lg">
                                                                <div className="items-center w-full p-8 space-y-4 text-gray-500 md:space-y-0">
                                                                        <div className="flex items-end justify-between">
                                                                                ...
                                                                                <div>({totalImages}/{IMAGE_TOTAL_MAX})</div>
                                                                        </div>

                                                                        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 pt-4">
                                                                                {supplierImages && supplierImages.map((image) => (
                                                                                        <div key={image.id} className="hover:relative h-60 w-full overflow-hidden">
                                                                                                <img
                                                                                                        className="h-full w-full object-cover rounded-lg"
                                                                                                        src={IMAGE_STORAGE_PATH + image.path}
                                                                                                        alt=""
                                                                                                />
                                                                                                <div
                                                                                                        ...
                                                                                                        onClick={() => !isDeleting && handleDeteleImage(image.id)}
                                                                                                >
                                                                                                        {isDeleting

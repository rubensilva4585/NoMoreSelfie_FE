...
export default function SupplierContacts(props) {
	...
	function submitSocials(e) {
		...
		if (
			!usernamePattern.test(social.instagram) &&
			social.instagram !== ""
		) {
		...
		if (
			!usernamePattern.test(social.pinterest) &&
			social.pinterest !== ""
		) {
		...
		if (
			social.website &&
			!websitePattern.test(social.website) &&
			social.website !== ""
		) {
						...
						<div className="items-top w-full p-4 space-y-4 text-gray-500 md:inline-flex md:space-y-0">
							<div className="max-w-xl md:max-w-sm mx-auto md:w-1/3 pr-5">
								...
								<span className="text-sm">
									Preencha os campos com os links das suas
									redes sociais e do seu website/portfolio, de
									modo a dar a conhecer o seu trabalho para o
									público e futuros clientes.
								</span>
							</div>

...
export default function Footer() {
    ...
    return (
        <footer class="bg-black lg:grid lg:grid-cols-5">
            <div class="relative block h-32 lg:col-span-2 lg:h-full">
                <img
                    ...
                    class="filter brightness-50 absolute inset-0 h-full w-full object-cover"
                />
            </div>
            ...
            <div class="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
                        ...
                        <ul class="mt-8 flex gap-6">
                            <li>
                                <a
                                    ...
                                    rel="noreferrer"
                                    target="_blank"
                                    class="transition hover:opacity-75 text-gray-200 text-xl"
                                >
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            <p class="font-medium text-white">Categorias</p>
                        ...
                        <div>
                            <p class="font-medium text-gray-900 dark:text-white">Links</p>
                ...
                <div class="mt-12 border-t border-gray-100 pt-12 dark:border-gray-800">
                    <div class="sm:flex sm:items-center sm:justify-between">
                        ...
                        <p class="mt-8 text-xs text-gray-500 dark:text-gray-400 sm:mt-0">
                            &copy; {new Date().getFullYear()} NoMoreSelfie. All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
        ...
        //                 © NoMoreSelfie {new Date().getFullYear()}
        //         </div>
        //     </div>
        // </footer>
    )

    ...
    <>
      <header
        className={`
                    ${
                      home
                        ? `top-0 left-0 right-0 z-30 transition ease-in duration-200 ${
                            isScrolled
                              ? "bg-white text-black fixed w-full shadow-md"
                              : "absolute text-white"
                          }`
        ...
        >
          <div className="items-center justify-between md:flex">
            <div className="flex items-center justify-between">
              <Link
                to="/"
                className="text-center text-xl xl:text-2xl text-orange-400"
              >
                NoMoreSelfie
              </Link>
            ...
            <div className="items-center hidden md:flex">
              <Link
                to="/"
                className="mx-3 text-md uppercase cursor-pointer hover:text-orange-400"
              >
                Página Inicial
              </Link>
              <Link
                    ...
                    <div className="relative inline-block text-left">
                      ...
                      {userToken ? (
                            ...
                            <>
                              <div ref={profileMenuRef}>
                                <button
                                  ...
                                  type="button"
                                  className={`flex items-center justify-center w-full rounded-md px-4 py-2 text-gray-700 hover:bg-gray-50/50 focus:outline-none`}
                                  id="options-menu"
                                >
                                    ...
                                    >
                                      ...
                                      {userRole === "admin" && (
                                        <>
                                          ...
                                          >
                                            <span className="flex flex-col">
                                              <span>Painel Administração</span>
                                            </span>
                                          </Link>
                                        </>
                                      )}
                        ...
                        <div className="flex items-center">
                          <Link
                            to="/login"
                            className="bg-orange-400 px-4 py-2 rounded text-white hover:bg-orange-500 text-sm"
                          >
                            Aceder
                          </Link>
                          <Link
                            to="/signin"
                            className={`${
                              isScrolled || !home ? "text-black" : "text-white"
                            } text-sm px-4 py-2`}
                          >
                            Registe-se
                          </Link>

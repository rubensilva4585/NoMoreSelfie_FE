...
export default function SearchModal(props) {
    ...
    const toastPromise = () => toast.promise(
            ...
            }),
        {
            ...
            success: <b>Pedido enviado com sucesso!</b>,
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <div className="relative flex justify-between items-center mb-4 max-w-xl">
                        <div className="flex flex-col gap-2">
                            <h2 className="text-2xl font-bold text-gray-800">
                                Pedir informação
                            </h2>
                            <p className="text-md text-gray-600">
                                Preencha este formulário e {props.supplier_name}{" "}
                                entrará em contacto consigo em breve.
                            </p>
                        </div>
                        <AiOutlineClose
                            onClick={props.closeModal}
                            className="absolute top-0 right-0 text-gray-400 hover:text-gray-800  text-2xl transition ease-in duration-200"
                        />
                    </div>
                    <form onSubmit={handleSubmit}>
                        <div className="mb-4">
                            <label
                                htmlFor="name"
                                className="block font-light text-gray-400 mb-2"
                            >
                                Nome:
                            </label>
                            <input
                                type="text"
                                id="name"
                                className={` rounded-lg flex-1 appearance-none border ${requestErrors.name
                                        ? "border-red-500"
                                        : "border-gray-300"
                                    } w-full py-3.5 px-5 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition ease-in duration-200 hover:bg-gray-50`}
                                name="name"
                                placeholder="Nome"
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                type="email"
                                id="email"
                                className={`rounded-lg flex-1 appearance-none border ${requestErrors.email
                                        ? "border-red-500"
                                        : "border-gray-300"
                                    }  w-full py-3.5 px-5 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition ease-in duration-200 hover:bg-gray-50`}
                                name="email"
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                type="tel"
                                id="phone"
                                className={`rounded-lg flex-1 appearance-none border ${requestErrors.phone
                                        ? "border-red-500"
                                        : "border-gray-300"
                                    } w-full py-3.5 px-5 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition ease-in duration-200 hover:bg-gray-50`}
                                name="phone"
                        ...
                        <div className="mb-4">
                            ...
                            <textarea
                                ...
                                name="description"
                                rows="3"
                                className={`w-full border rounded-lg resize-none flex-1 appearance-none  ${requestErrors.description
                                        ? "border-red-500"
                                        : "border-gray-300"
                                    } py-3.5 px-5 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition ease-in duration-200 hover:bg-gray-50`}

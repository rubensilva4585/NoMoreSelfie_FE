            ...
            <section className=" bg-gray-100/50 py-16">
                <div className="container max-w-4xl mx-auto shadow-md">
                    <div className="p-4 border-t-2 border-orange-400 rounded-lg bg-gray-100/5 flex justify-between items-center">
                        <h2 className="text-2xl leading-tight">Definições de conta</h2>
                    </div>
                    {!(districts && user) ? (
                        <>
                            ...
                            <div className="space-y-6 bg-white">
                                        ...
                                        <div className=" relative flex flex-col gap-4">
                                            ...
                                            >
                                                <div className="relative">
                                                    ...
                                                    <input
                                                        className={`rounded-lg flex-1 appearance-none border ${personalInfoError.name === ""
                                                            ? "border-gray-200"
                                                            : "border-red-500"
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <input
                                                        className={` rounded-lg flex-1 appearance-none border ${personalInfoError.dob === ""
                                                            ? "border-gray-200"
                                                            : "border-red-500"
                                                            } w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition ease-in duration-200 hover:bg-gray-50`}
                                                        type="date"
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <input
                                                        className={` rounded-lg flex-1 appearance-none border ${personalInfoError.phone === ""
                                                            ? "border-gray-200"
                                                            : "border-red-500"
                                                            } w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition ease-in duration-200 hover:bg-gray-50`}
                                                        type="tel"
                                                ...
                                                {userRole === "supplier" && (
                                                    <>
                                                        <div className="relative">
                                                            ...
                                                            <input
                                                                className={` rounded-lg flex-1 appearance-none border ${personalInfoError.company === ""
                                                                    ? "border-gray-200"
                                                                    : "border-red-500"
                                                                    } w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition ease-in duration-200 hover:bg-gray-50`}
                                                                type="text"
                                                        ...
                                                        <div className="relative">
                                                            <label htmlFor="name">NIF</label>
                                                            <input
                                                                className={` rounded-lg flex-1 appearance-none border ${personalInfoError.nif === ""
                                                                    ? "border-gray-200"
                                                                    : "border-red-500"
                                                                    } w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition ease-in duration-200 hover:bg-gray-50`}
                                                                type="text"
                                                        ...
                                                        <div className="relative">
                                                            <label htmlFor="name">Vive em...</label>
                                                            <Select
                                                                options={districts}
                                                                onChange={(e) =>
                                                                    e
                                                                ...
                                                                defaultValue={
                                                                    ...
                                                                    districts.find(
                                                                        (district) =>
                                                                            district.value === user.district.id
                                                                    )
                                                                }
                                                                isSearchable={true}
                                                                isClearable={true}
                                                        ...
                                                        <div className="relative">
                                                            ...
                                                            <textarea
                                                                className={` rounded-lg flex-1 appearance-none border ${personalInfoError.bio === ""
                                                                    ? "border-gray-200"
                                                                    : "border-red-500"
                                                                    } w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition ease-in duration-200 hover:bg-gray-50`}
                                                                rows="3"
                                        ...
                                        <div className=" relative flex flex-col gap-4">
                                            ...
                                            <form onSubmit={handleSubmitUserEmail}>
                                                <div className="relative">
                                                    ...
                                                    <input
                                                        className={`rounded-lg flex-1 appearance-none border ${changeEmail.email === user.email ||
                                        ...
                                        <div className=" relative flex flex-col gap-4">
                                            ...
                                            >
                                                <div className="relative">
                                                    ...
                                                    <input
                                                        className={` rounded-lg flex-1 appearance-none border ${!changePassword.passwordError
                                                            ? "border-gray-200"
                                                            : "border-red-500"
                                                            } w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition ease-in duration-200 hover:bg-gray-50`}
                                                        type="password"
                                ...
                                <div className="items-center w-full p-8 space-y-4 text-gray-500 md:inline-flex md:space-y-0">
                                    ...
                                    <div className="max-w-sm mx-auto space-y-5 md:w-2/3 ">
                                        <div className=" relative flex flex-col gap-4">
                                            <div>
                                                Ao eliminar a sua conta em NoMoreSelfie.pt todas as
                                                informações e conteúdos armazenados nessa conta serão{" "}
                                                <span className="font-semibold text-black">
                                                    perdidos
                                                </span>
                                                .

			...
			<section className=" bg-black">
				<div className="container mx-auto px-3 md:px-12 py-20">
					...
					<div className="flex gap-5 overflow-x-auto">
						<HomeSectionDistrictsDistrictCard
							imageUrl="../../../images/districts/districtPorto.jpg"
							title="Porto"
							district_id={13}
						/>
						<HomeSectionDistrictsDistrictCard
							imageUrl="../../../images/districts/districtLisboa.jpg"
							title="Lisboa"
							district_id={11}
						/>
						<HomeSectionDistrictsDistrictCard
							imageUrl="../../../images/districts/districtCoimbra.jpg"
							title="Coimbra"
							district_id={6}
						/>
						<HomeSectionDistrictsDistrictCard
							imageUrl="../../../images/districts/districtAveiro.jpg"
							title="Aveiro"
							district_id={1}
						/>
						<HomeSectionDistrictsDistrictCard
							imageUrl="../../../images/districts/districtAlgarve.jpg"
							title="Faro"
							district_id={8}
						/>
					</div>
